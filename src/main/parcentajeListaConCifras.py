...
if __name__ == '__main__':
    url = 'C:/Users/EMANON/Desktop/Tesis/graficos/datos-{}'
    files = [
    ...
    for i in range(1,239):
        ...
        for file in files:
            ...
            #os.system('pause')
            Grafico._replace_all(url.format(i)+file, dataLog[0], str(dataLog[0]).replace('razon_de_arribo', 'razon_privacidad'))
